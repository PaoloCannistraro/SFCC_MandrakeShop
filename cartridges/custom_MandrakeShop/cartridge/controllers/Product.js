    ...
    if (!showProductPageHelperResult.product.online && productType !== 'set' && productType !== 'bundle') {
        ...
        if (pageLookupResult.page) {
            ...
            res.render(showProductPageHelperResult.template, {
                ...
                clockFrequency:showProductPageHelperResult.clockFrequency,
                clockMemory:showProductPageHelperResult.clockMemory, 
                sizeMemory:showProductPageHelperResult.sizeMemory, 
                voltage:showProductPageHelperResult.voltage,
                tdp:showProductPageHelperResult.tdp
            });
        }
    }
    next();
